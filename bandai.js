$(document).ready(function () {
    ...
    if (!isRunning) {
        helpers.createStartTrigger().appendTo(helpers.getParentOfTriggers()).click(macro.start);
        return;
    }

    helpers.createStopTrigger().appendTo(helpers.getParentOfTriggers()).click(macro.stop);
...
const helpers = (function () {
    ...
    return {
        createStartTrigger: function () {
            return $('<a href="#" style="margin-left:5px;"><img src="' + chrome.runtime.getURL('btn_start.png') + '" alt="start"></a>');
        },
        createStopTrigger: function () {
            return $('<a href="#" style="margin-left:5px;"><img src="' + chrome.runtime.getURL('btn_stop.png') + '" alt="stop"></a>');
        },
